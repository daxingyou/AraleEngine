...
public class Ipv6Mgr : SingletonIns<Ipv6Mgr>
{
    ...
    /// 增加参数 是否V6
    public static string GetIpV6(string hostOrHostName, out AddressFamily convertedFamily)
    {
    ...
    public static string FinalUrl(string url)
    {
        ...
        AddressFamily convertedFamily;
        finalIp = GetIpV6 (hostOrName,out  convertedFamily);
